...
export default function Reservation() {
  const hasOnlineReservation = storeData.reservation.onlineUrl && storeData.reservation.onlineUrl !== ''
  ...
  return (
    <section id="reservation" className="py-20 bg-white">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className={`grid ${hasOnlineReservation ? 'sm:grid-cols-2' : 'sm:grid-cols-1 max-w-sm mx-auto'} gap-6 mb-8`}>
          <div className="bg-warm-50 rounded-lg p-6 border border-stone-100 flex flex-col items-center text-center">
            ...
            <a
              ...
              className="text-2xl font-bold text-stone-800 hover:text-stone-600 transition-colors mb-2"
            >
          ...
          {hasOnlineReservation && (
            <div className="bg-warm-50 rounded-lg p-6 border border-stone-100 flex flex-col items-center text-center">
              <div className="w-14 h-14 bg-stone-600 rounded-full flex items-center justify-center mb-4">
